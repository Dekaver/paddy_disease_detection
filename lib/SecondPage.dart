...
// const Color discountBackground = Color.fromARGB(255, 57, 176, 39);
// const Color flightColor = Color.fromARGB(255, 57, 176, 39);
// final Color chipBackground = const Color.fromARGB(255, 243, 219, 33).withOpacity(.2);
// final Color borderColor = const Color.fromARGB(255, 57, 176, 39).withAlpha(100);
// String? fromlocation;
// String? tolocation;
...
//             children: <Widget>[const StackTop(), StackDown()],
//           ),
//         ));
//   }
// }
...
//                     const Radius.elliptical(10, 20), const Radius.circular(20), 2)!),
...
//   Tag({Key? key, this.avatar, this.label}) : super(key: key);
...
//   const StackTop({Key? key}) : super(key: key);
